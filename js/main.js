 ...
 */
async function createGame(player1 = "Left player", player2 = "Right player", ) {
	return (new Promise((resolve) => {
		...
		new GLTFLoader().load('static/models/arcade_room.gltf', (gltf) => {
			...
			meshes.paddleL.name = player1;
			meshes.paddleR.name = player2;
 ...
 */
async function launchGame(properties = undefined) {
	if (!properties)
